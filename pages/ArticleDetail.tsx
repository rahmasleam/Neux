...
import { ArrowLeft, ExternalLink, Bookmark, Bot, Globe, Calendar, User, Maximize2, Minimize2, BookOpen, Loader2, Volume2, StopCircle } from 'lucide-react';
...
const ArticleDetail: React.FC = () => {
    ...
    const playAudio = async () => {
        ...
        // Read first 500 chars for demo/speed or send chunks
        setIsPlaying(true);
        const textToRead = articleText.substring(0, 800) + "..."; 
                                ...
                                {isLoadingText ? (
                                    ...
                                    <div className="prose dark:prose-invert max-w-none">
                                        ...
                                        {articleText.split('\n').map((line, i) => {
                                            ...
                                            return <p key={i} className="mb-4 text-lg leading-relaxed text-slate-800 dark:text-slate-200">{line}</p>;
                                        })}
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="p-6 md:p-8">
                                <div className="flex justify-between items-center mb-6">
                                     ...
                                     >
                                        ...
                                        {isTranslating ? 'Translating...' : (translatedTitle ? 'Show Original' : 'Translate')}
                                     </button>
                                </div>
