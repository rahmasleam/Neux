        ...
        <div className="max-w-6xl mx-auto space-y-8 pb-20 animate-fadeIn">
            ...
            <div className="flex flex-col gap-4">
                 <button 
                    ...
                    className="flex items-center gap-2 text-slate-500 hover:text-nexus-600 transition-colors w-fit"
                >
            ...
            {/* Main Tool Section */}
            <div className="bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-950/30 dark:to-slate-800 border border-indigo-100 dark:border-indigo-900 rounded-2xl p-6 md:p-8 shadow-sm">
                <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                        ...
                        <form onSubmit={handleDeepAnalysis} className="flex flex-col md:flex-row gap-4 mb-6">
                            <input 
                                type="url" 
                                placeholder="Paste Podcast or YouTube Link here..." 
                                value={analysisUrl}
                                onChange={(e) => setAnalysisUrl(e.target.value)}
                                className="flex-1 p-4 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none bg-white dark:bg-slate-900 dark:text-white text-lg shadow-sm"
                                required
                            />
                            <button 
                                type="submit" 
                                disabled={isAnalyzing}
                                className="px-8 py-4 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 font-bold flex items-center justify-center gap-2 disabled:opacity-50 shadow-lg hover:shadow-indigo-500/30 transition-all"
                            >
                        ...
                        {analysisData && (
                            <div className="mt-8 animate-fadeIn">
                                <div id="full-report" className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-8 shadow-lg">
