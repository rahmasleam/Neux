...
export const PODCASTS: PodcastItem[] = [
  // ARABIC PODCASTS
  {
    ...
    url: 'https://podcasts.apple.com/sa/podcast/swalf-business/',
    date: getDate(-1),
  ...
  },
  {
    ...
    region: 'MENA',
    source: 'Dubai Future',
    url: 'https://dubaifuture.ae/podcast',
    date: getDate(-3),
  ...
  },
  {
    ...
    region: 'Egypt',
    source: 'SoundCloud',
    url: 'https://soundcloud.com/user-5business',
    date: getDate(-5),
  ...
  },
  {
    ...
    region: 'MENA',
    source: 'Anghami',
    url: 'https://play.anghami.com/podcast',
    date: getDate(-2),
  ...
  // ENGLISH PODCASTS
  {
    ...
    region: 'Global',
    source: 'Apple Podcasts',
    url: 'https://podcasts.apple.com/us/podcast/recode-decode/',
    date: getDate(-2),
  ...
  },
  {
    ...
    region: 'Global',
    source: 'Spotify',
    url: 'https://open.spotify.com/show/555',
    date: getDate(-4),
